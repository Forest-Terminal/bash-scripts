...
**Installation**
Make sure to replace /home/forest-terminal/ with your user's home dirrectory
**Bash Compatbility**
Simply replace all of the `.zshrc` file mentions to be `.bashrc` instead.

## Wallpaper.sh
A basic terminal wallpaper switcher with search and preview ability. (Optional ability to work with a custom themed setup.)
